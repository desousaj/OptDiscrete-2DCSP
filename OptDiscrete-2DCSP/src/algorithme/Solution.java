...
public class Solution extends SolutionAbstract {
	...
	public Solution(Data data) {
		...
		/* DÈbut faire un constructeur de base avec toutes les images ‡ 0 */
		int cpt = 0;
	...
	/**
	 * Fonction qui met √† jour le nombre de fois qu'il faut imprimer chaque
	 * planche pour avoir toute les images. Si l'image est sur diff√©rent
